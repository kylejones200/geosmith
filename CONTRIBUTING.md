# Contributing to geosmith

Thank you for your interest in contributing to geosmith! This document provides guidelines and instructions for contributing.
...
git clone https://github.com/YOUR_USERNAME/geosmith.git
cd geosmith
```
